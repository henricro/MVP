...
### SERVER DOMAIN
application.config['SERVER_DOMAIN'] = os.environ.get('SERVER_DOMAIN','https://gyst.fr')
...
from MVP.views import create_note, delete_note, links, new_page, open_page, unload, update, upload_image, upload, login, celery_view, login, passwords, \
    ...
    youtube, move_note, paste_note, add_css, lines, categories, sign_up, lists, to_do_lists, save_sizes, download
